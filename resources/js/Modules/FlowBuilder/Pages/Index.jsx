            ...
            <div className="py-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                ...
                {flows.length === 0 ? (
                    <div className="bg-white border border-gray-200 rounded-2xl p-12 text-center">
                        <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-600">
                            <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z" />
                            </svg>
                        </div>
                        <h3 className="text-lg font-semibold text-gray-800">No Flows Created Yet</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {flows.map((flow) => (
                            <div
                                key={flow.id}
                                className="bg-white border border-gray-200 hover:border-gray-300 rounded-2xl p-6 transition-all flex flex-col justify-between"
                            >
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center gap-4 text-xs text-gray-500 border-t border-b border-gray-200/80 py-3">
                                        <div>
                                            <span className="text-gray-400 block">Active Sessions</span>
                                            <span className="font-semibold text-gray-800">{flow.active_sessions}</span>
                                        </div>
                                        <div className="border-l border-gray-200 pl-4">
                                            <span className="text-gray-400 block">Created</span>
                                            <span className="font-semibold text-gray-800">{flow.created_at}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center justify-between pt-4 mt-2">
                                    <Link
                                        ...
                                        className="inline-flex items-center gap-1.5 text-sm font-semibold text-indigo-600 hover:text-indigo-300 transition-colors"
                                    >
                                        Open Canvas Editor
                                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <button
                                        ...
                                        className="text-gray-400 hover:text-rose-600 p-1.5 rounded-lg hover:bg-rose-500/10 transition-colors"
                                        title="Delete Flow"
                                    >
                                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {isCreateOpen && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-sm">
                        <div className="bg-white border border-gray-200 rounded-2xl w-full max-w-md p-6 space-y-5 shadow-2xl">
                            <div className="flex items-center justify-between">
                                <h3 className="text-lg font-bold text-gray-900">Create New Flow</h3>
                                <button
                            ...
                            <form onSubmit={handleCreate} className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-800 focus:outline-none focus:border-indigo-500"
                                        required
                                    />
                                    {errors.name && (
